...
//     const geoResponse = await fetch(`https://ipinfo.io/${ipAddress}?token=a65aa5704d8782`);
//     const geoData = await geoResponse.json();
...
// function getpostdata(val) {
//     let datas = [{ PostOffice: [] }]; // Initialize datas as an array of objects
//     let cval = val.toLowerCase();
...
//       con.innerHTML = '';
//       datas[0].PostOffice = data; // Store filtered data in datas at the 0 position
//       displaypost(datas);
//     }
//   }
